...
#===============================================================================
# Custom modification by Sprinter05 
# Implements tmux-mode-indicator
...
RS="#[fg=$TC]$larrow#{tmux_mode_indicator}#[fg=$BG,bg=$TC]$larrow#[fg=$TC,bg=$BG]$larrow#[fg=$BG,bg=$TC] $time_icon $time_format "
